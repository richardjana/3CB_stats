        ...
        <nav className="nav">
          <ul className="nav-list">
            <li className="nav-item">
              <Link to="/halloffame" className="link">
                Hall of Fame
              </Link>
            </li>
                ...
                <ul className="dropdown-menu">
                  {roundNumbers.map((num) => (
                    <li key={num} className="dropdown-item">
                      <Link to={`/round/${num}`} className="link">
                        Runde {num}
                      </Link>
                    </li>
                  ))}
                ...
                <ul className="dropdown-menu">
                  {playerNames.map((p) => (
                    <li key={p} className="dropdown-item">
                      <Link to={`/player/${p}`} className="link">
                        {p}
                      </Link>
                    </li>
                  ))}
            ...
            <li className="nav-item">
              <Link to="/bannedlist" className="link">
                Bannedlist
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/popularcards" className="link">
                Oft gespielte Karten
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/apidocumentation" className="link">
                API
              </Link>
            </li>
          </ul>
